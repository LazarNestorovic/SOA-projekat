...
async function createBlog(req, res) {
  ...
  try {
    ...
    console.error(err);
    return res.status(500).json({ error: 'Greška pri kreiranju bloga' });
  }
}
...
async function getBlogs(req, res) {
  try {
    ...
    console.error(err);
    return res.status(500).json({ error: 'Greška pri dohvatanju blogova' });
  }
}
...
async function getBlog(req, res) {
  ...
  try {
    ...
    console.error(err);
    return res.status(500).json({ error: 'Greška pri dohvatanju bloga' });
  }
}
